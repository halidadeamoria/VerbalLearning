...
import com.example.articulationlearning.databinding.FragmentInformasiBinding;
...
public class InformasiFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        KategoriMenuAdapter adapter = new KategoriMenuAdapter((BaseAppCompatActivity) requireActivity());
